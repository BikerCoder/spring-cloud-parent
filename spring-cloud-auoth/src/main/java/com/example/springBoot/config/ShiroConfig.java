...
import com.example.springBoot.mapper.RedisSessionDAO;
import com.example.springBoot.realm.UserRealm;
import com.example.springBoot.service.MyWebSessionManager;
...
public class ShiroConfig {
	...
	public MyWebSessionManager defaultWebSessionManager() {
		...
		manager.setGlobalSessionTimeout(28800000);// 设置全局session超时时间
